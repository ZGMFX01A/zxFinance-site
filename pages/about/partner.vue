<template>
  <div class="text-box">
    <div class="text-content" id="text-content">
      ...
      <ul class="mt20 clearfix partner">
        <li class="mt10 partner-item clearfix">
          <a href="" class="logo" style="margin-top:50px">
            <img src="~/assets/images/ips.jpg" style="vertical-align:middle" />
          </a>
          <div class="text">
            <h5>
              北京大成律师事务所
            ...
            <p class="cn_line" style="text-indent:0;">
              北京大成律师事务所成立于2014年5月15日，主要从事的业务领域包括诉讼及争议解决、建筑房地产、公用事业、境内上市、境外上市、重组并购、税务、金融和银行、国际贸易等。
              北京大成律师事务所有合伙人200余名，已有众多世界500强企业、跨国公司、外商投资企业、国际和本土金融机构及投资基金成为众享金融的长期客户和良好合作伙伴。
            </p>
          </div>
        </li>
        <li class="mt10 partner-item clearfix">
          ...
          <div class="text">
            ...
            <p class="cn_line" style="text-indent:0;">
              ...
              QSP认证（第三方支付公司资质认证方案，Qualified Service
              Provider）的第三方支付企业。
